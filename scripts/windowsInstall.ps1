...
foreach ($file in $filesmain){
    ...
    sudo New-Item -ItemType SymbolicLink -Path "$HOME/.$file" -Target "$dir/$file" 
    } 
...
echo "link config"
sudo New-Item -ItemType SymbolicLink -Path "$HOME/.config" -Target "$HOME/OneDrive/dotfiles/config" 
mkdir ~/.ctags.d
mv ~/.ctags.d/latex.ctags $olddir -Force -ErrorAction SilentlyContinue
sudo New-Item -ItemType SymbolicLink -Path "$HOME/.ctags.d/latex.ctags" -Target "$HOME/OneDrive/dotfiles/ctags"
mv C:/Users/yasha/AppData/Roaming/nushell/config.nu $olddir 
sudo New-Item -ItemType SymbolicLink -Path "$HOME/AppData/Roaming/nushell/config.nu" -Target $HOME/OneDrive/dotfiles/config/nushell/config.nu
mv C:/Users/yasha/AppData/Roaming/nushell/env.nu $olddir
sudo New-Item -ItemType SymbolicLink -Path "$HOME/AppData/Roaming/nushell/env.nu" -Target $HOME/OneDrive/dotfiles/config/nushell/env.nu
...
sudo New-Item -ItemType SymbolicLink -Path "$HOME/AppData/Local/nvim" -Target "$HOME/OneDrive/dotfiles/config/nvimnew"
mv $HOME/Users/yasha/AppData/Local/lf/lfrc $olddir
sudo new-Item -ItemType SymbolicLink -Path "$HOME/AppData/Local/lf/lfrc" -Target "$HOME/OneDrive/dotfiles/config/lf/lfrc"
mv $HOME/AppData/Roaming/Microsoft/Windows/Start Menu/Programs/Startup/desktop-switcher.ahk $olddir
sudo new-Item -ItemType SymbolicLink -Path "$HOME/AppData/Roaming/Microsoft/Windows/Start Menu/Programs/Startup/desktop_switcher.ahk" -Target "$HOME/OneDrive/dotfiles/scripts/desktop_switcher.ahk"
sudo new-Item -ItemType SymbolicLink -Path "$HOME/windows-desktop-switcher" -Target "$HOME/OneDrive/windows-desktop-switcher"
