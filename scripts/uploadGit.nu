...
do --ignore-errors {pwsh -nop -c New-Item -ItemType SymbolicLink -Path ./link.bib -Target C:/Users/yasha/onedrive/dotfiles/link.bib 
}
...
pwsh -nop -c 'git commit -m "fist commit"; git push origin master; echo "dude"'
}
