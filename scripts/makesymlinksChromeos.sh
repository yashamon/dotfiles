...
sudo apt install python3 kitty python-pip zathura zathura-ps zathura-djvu xdotool inkscape texlive 
...
ninja-build pkg-config python3-pip software-properties-common unzip sptv
