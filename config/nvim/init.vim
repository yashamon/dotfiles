...
nmap <leader>m :silent ! cp % backup;  pandoc  backup -s --webtex -o backup.text; pandoc backup.html --from html --to markdown_strict -o backup.md; cp backup.md %<cr>:e %<cr>:w<cr>:qa<cr> 
