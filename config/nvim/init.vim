...
nmap <leader>m :silent ! cp % backup;  
pandoc --toc --standalone --webtex -f latex -t markdown backup -o backup.html

pandoc  backup -s --webtex -o backup.html;  cp backup.html %<cr>:e %<cr>:w<cr>:qa<cr> 
