...
nmap <leader>m :silent ! cp % backup;  pandoc  backup -s --webtex -o backup.html; pandoc backup.html --from html --to markdown_strict -o backup.md; cp backup.md %; rm backup.md:e %<cr>:w<cr>:qa<cr> 
