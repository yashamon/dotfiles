...
nmap <leader>m :silent ! cat % >> ~/workspace/email; cp % /tmp/temp; make4ht /tmp/temp "mathml,mathjax"; pandoc /tmp/temp.html --from html --to markdown_strict -o /tmp/temp.md; mv temp.md %<cr>:e %<cr>:w<cr>:qa<cr>
