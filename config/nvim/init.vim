...
nmap <leader>m :silent ! cat % >> ~/workspace/email; cp % email; make4ht backup "mathml,mathjax"; pandoc backup.html --from html --to markdown_strict -o backup.md; mv backup.md %<cr>:e %<cr>:w<cr>:qa<cr>
