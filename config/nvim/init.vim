...
nmap <leader>m :silent ! cat % >> ~/workspace/email; cp % temp; make4ht temp "mathml,mathjax"; pandoc temp.html --from html --to markdown_strict -o backup.md; mv temp.md %; rm temp; rm temp.html<cr>:e %<cr>:w<cr>:qa<cr>
