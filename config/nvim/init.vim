...
nmap <leader>m :silent ! cat % >> ~/workspace/email; cp % /tmp/temp; make4ht /tmp/temp "mathml,mathjax"; pandoc temp.html --from html --to markdown_strict -o backup.md; mv temp.md %<cr>:e %<cr>:w<cr>:qa<cr>
