...
command! -bang -nargs=* BLinesB
         \ call fzf#vim#grep("rg  --with-filename --column --line-number --no-heading --color=always --smart-case -- ".fnameescape(expand('%:p')).shellescape(<q-args>), 1, fzf#vim#with_preview(), <bang>0)
"     \ call fzf#vim#grep(
