...
command! -bang -nargs=* BLinesB
         \ call fzf#vim#grep("rg -f .fnameescape(expand('%:p') --with-filename --column --line-number --no-heading --color=always --smart-case -- ".shellescape(<q-args>), 1, fzf#vim#with_preview(), <bang>0)
"     \ call fzf#vim#grep(
