...
<Space> .
<CR><Esc><leader>j 1442:  " noremap S :S  1443:  " 1444:  " 1445:  " function! Sneak() 1446:  "     hi! link Sneak Normal 1447:  "     hi! link SneakScope Normal 1448:  "     execute 'normal!  <Plug>Sneak s' 1449:  "     syntax on 1450:  " endfunction 1451:    1452:  " map N <Plug>Sneak , 1453:  " map t <Plug>(smalls-excursion) 1454:  " let g:smalls auto jump=1 1455:  " let g:smalls auto jump timeout=0 1456:   1457:   1458:      " xmap t <Plug>Sneak s 1459:      " xmap T <Plug>Sneak S 1460:     " omap t <Plug>Sneak s 1461:      " omap T <Plug>Sneak S    1462:      " >Sneak S+ test 1463:  testu 1464:      " math maps     asdf a;sldfjk test2 spank    1465:  "  1466:  " silent execute 'AsyncRun if git rev-parse --is-inside-work-tree || git rev-parse --git-dir > /dev/null 2>&1 ; then git add   ; git commit -m -a ; git push --all origin; fi' 1467:  " let g:vimtex view general options = '-r @line @pdf @ 1468:  """ pandoc backup -s html -o markdown cp backup.
