...
vim' 29:  Plug 'vim-scripts/AutoTag' 30:  Plug 'mbbill/undotree',   'on': 'UndotreeToggle'   31:   32:  " Plug 'rebelot/kanagawa.
nvim' 33:  " Plug 'reedes/vim-pencil'  34:  " Plug 'folke/which-key.
nvim',   'branch': 'main'   35:  " Plug 'folke/zen-mode.
nvim',    'branch': 'main'    36:  " Plug 'lewis6991/spellsitter.
nvim' 37:  " Plug 'radenling/vim-dispatch-neovim'   38:  " Plug 'tpope/vim-dispatch' 39:  " Plug 'sheerun/vim-polyglot'  40:  " Plug 'https://gitlab.
com/yorickpeterse/nvim-dd.
git',    'branch': 'main'   41:  " Plug 'luukvbaal/stabilize.
nvim'  42:  " Plug 'nvim-lua/plenary.
nvim' 43:  " Plug 'nvim-telescope/telescope.
nvim', 44:  " Plug 'nvim-treesitter/playground 45:  " Plug 'Pocco81/TrueZen.
nvim',   'branch': 'main'   46:  " Plug 'glepnir/lspsaga.
nvim' 47:  " If you are using Vim-Plug 48:  " Plug 'hrsh7th/cmp-nvim-lsp',   'branch': 'main'    49:  " " Plug 'kdheepak/cmp-latex-symbols',   'branch': 'main'    50:  " Plug 'hrsh7th/cmp-buffer',   'branch': 'main'   51:  " " Plug 'kabouzeid/nvim-lspinstall',   'branch': 'main'   52:  " "Plug 'pope/vim-obsession' 53:  " "Plug 'xolox/vim-easytags' 54:  " " Plug 'nvim-lua/plenary.
nvim' 55:  " " Plug 'windwp/nvim-spectre' 56:  " " Plug 'xolox/vim-misc' 57:  " " Plug 'ray-x/cmp-treesitter' 58:  " " For luasnip user.
...
438:++++ ` 439:  noremap <m-1> <C-o> 440:  noremap <m-2> <C-i> 441:  noremap <D-d> <C-d>  442:  map ;w <Esc>:w<CR> 443:  noremap <D-u> <C-u> 444:  noremap <A-u> <C-u>  445:  " this mapping Enter key to <C-y> to chose the current highlight item  446:  " and close he selection list, same as other IDEs.
...
git[ /  ]COMMIT EDITMSG ' && line("' "") > 1 && line("' "") <= line(" ") | exe "normal! g` "" | endif 1467:   1468:         1469:  "other maps    1470:   1471:  inoremap <cr> <cr><space><esc>" s 1472:  nnoremap o o<space><esc>" s 1473:  let g:neovide fullscreen=v:true 1474:  if exists('g:gonvim running') 1475:      "goneovim specific stuff 1476:  elseif exists('g:neovide') 1477:     set guifont=Fira  Code  Light:h20 1478:  end 
