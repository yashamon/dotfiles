...
git[ /  ]COMMIT EDITMSG ' && line("' "") > 1 && line("' "") <= line(" ") | exe "normal! g` "" | endif 1467:   1468:         1469:  "other maps    1470:   1471:  inoremap <cr> <cr><space><esc>" s 1472:  nnoremap o o<space><esc>" s 1473:   