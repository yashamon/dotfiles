...
def hw [] { pandoc $"($HOMED)/web/classes/CalcIII/2023.md" -o $"($HOMED)/web/classes/CalcIII/2023.html" ;  pandoc $"($HOMED)/web/classes/ModernGeometry/2023.md" -o $"($HOMED)/web/classes/ModernGeometry/2023.html" ; cd $"($HOMED)/web"; git add . ; git commit -m -a ; git push origin gh-pages 
} 
