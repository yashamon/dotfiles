...
def hw [] { pandoc $"($HOMED)/web/classes/topology/2024.md" -o $"($HOMED)/web/classes/toplogy/2024.html" ;  pandoc $"($HOMED)/web/classes/algtop/2024.tex" -o $"($HOMED)/web/classes/algtop/2024.html" ; cd $"($HOMED)/web"; git add . ; git commit -m -a ; git push origin gh-pages 
} 
