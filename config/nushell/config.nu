...
def hw [] { pandoc $"($HOMED)/web/classes/CalcIII/2023.md" -o $"($HOMED)/web/classes/CalcIII/2023.html" ;  pandoc $"($HOMED)/web/classes/ModernGeometry/2023.tex" -o $"($HOMED)/web/classes/ModernGeometry/2023.html" ; cd $"($HOMED)/web"; do --ignore-errors {git add .}; do --ignore-errors {git commit -m -a}; do --ignore-errors {git push origin gh-pages} 
} 
