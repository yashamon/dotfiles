...
let path = $env.Path | append $scoop1 | append $scoop2 | append "C:/Users/yasha/scoop/shims" | append "C:/Users/yasha/.cargo/bin"
$env.Path = $path
...
def neo [file = ""] {
nu -c "C:/Users/yasha/scoop/apps/neovide/current/neovide.exe --opengl" $file
}
def vi [file = ""] {
nvy --maximize $file
}
