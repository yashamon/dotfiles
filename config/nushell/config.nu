...
def vi [file = ""] {
$"C:/Users/yasha/nvy/build/nvy --fullscreen
...
def hw [] { pandoc $"($HOMED)/web/classes/algtop/2024.tex" -o $"($HOMED)/web/classes/algtop/2024.html" ;  pandoc $"($HOMED)/web/classes/topology/2024.tex" -o $"($HOMED)/web/classes/topology/2024.html" ;do --ignore-errors {cd $"($HOMED)/web"}; do --ignore-errors {git add .}; do --ignore-errors {git commit -m -a}; do --ignore-errors {git push origin gh-pages} 
} 
