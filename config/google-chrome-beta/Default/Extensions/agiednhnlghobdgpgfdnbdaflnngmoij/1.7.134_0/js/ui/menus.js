define(["settings!menus,keys", "editor", "ui/dialog", "command", "util/template!templates/menuItem.html", "util/dom2"], function(Settings, editor, dialog, command, inflate) {
    ...
    var findKeyCombo = function(command, arg) {
        ...
        for (var key in keys) {
            ...
            if (verb == command) {
                ...
                key = key
                //back-compat
                .replace(/(\^|M)-([A-Z]+)$/, "$1-Shift-$2").replace(/\^-/g, "Ctrl-").replace(/M-/g, "Alt-")
    ...
    Menu.prototype = {
        ...
        bindEvents: function() {
            ...
            menubar.addEventListener("click", function(e) {
                ...
                menubar.findAll(".active").filter(function(n) {
                    return n != el
                }).forEach(function(n) {
        ...
        deactivate: function() {
            this.element.findAll(".active").forEach(function(node) {
