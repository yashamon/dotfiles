...
function getBookmarks(bookmarks) {
    ...
    for (var i =0; i < bookmarks.length; i++) {
        ...
        if (bookmark.children) {
            ...
            menu.append('<li><div data-url="' + url + '" class="navbar-text folder" title="' + bookmark.title + '"><i style="background:url(../images/yellow-folder.png) no-repeat"></i><span>' + bookmark.title + '</span></div></li>');
        }
    }
}
