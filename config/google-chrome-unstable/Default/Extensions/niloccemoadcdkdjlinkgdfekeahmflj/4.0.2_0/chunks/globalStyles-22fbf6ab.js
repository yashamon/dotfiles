...
const iconStyle = "igxbmuu"; // Higher Order Component that wraps individual icon components. Is not intended
...
const Icon = ({
  ...
  return /*#__PURE__*/React.createElement("span", _extends({
    className: `${iconStyle} icon ${className}`
...
Icon.propTypes = {
  ...
  title: function (props, propName, componentName, ...rest) {
    if (props[propName]) {
      PropTypes.string(props, propName, componentName, ...rest); // id is a prerequisite for title

      if (!props.id) {
        return new Error(`"id" prop is also required if ${propName} is passed to ${componentName}`);
      }
    }
  },
  ...
  description: function (props, propName, componentName, ...rest) {
    if (props[propName]) {
      PropTypes.string(props, propName, componentName, ...rest); // id and title are a prerequisite for description

      if (!props.id || !props.title) {
        return new Error(`"id" and "title" props both required if ${propName} is passed to ${componentName}`);
      }
    }
  }
};
...
var Error$1 = (({
  ...
  d: "M13.5 16.5a1.5 1.5 0 11-3 0 1.5 1.5 0 013 0zM13.736 7.982l-.604 4.527a1.142 1.142 0 01-2.264 0l-.604-4.527a1.751 1.751 0 113.472 0z"
}), children));
...
var Instagram = (({
  ...
  d: "M12 3.801c2.67 0 2.986.01 4.04.059.976.044 1.505.207 1.858.344.435.16.828.416 1.151.748.332.323.588.716.748 1.151.137.353.3.882.345 1.857.047 1.055.058 1.37.058 4.041 0 2.67-.01 2.987-.058 4.041-.045.975-.208 1.505-.345 1.857a3.314 3.314 0 0 1-1.898 1.898c-.352.137-.882.3-1.857.344-1.054.048-1.37.058-4.04.058s-2.987-.01-4.041-.058c-.975-.044-1.505-.207-1.857-.344a3.096 3.096 0 0 1-1.151-.748 3.096 3.096 0 0 1-.749-1.151c-.137-.353-.3-.883-.344-1.857-.048-1.055-.058-1.371-.058-4.041 0-2.67.01-2.987.058-4.041.045-.975.207-1.505.344-1.857.16-.435.416-.829.749-1.151a3.096 3.096 0 0 1 1.15-.749c.353-.137.883-.3 1.858-.344C9.015 3.81 9.33 3.8 12 3.8L12 3.8Zm.002-1.803c-2.716 0-3.057.012-4.124.06-1.066.05-1.793.22-2.428.466a4.91 4.91 0 0 0-1.772 1.154A4.91 4.91 0 0 0 2.525 5.45c-.247.635-.416 1.363-.465 2.427C2.012 8.942 2 9.284 2 12s.012 3.056.06 4.123c.05 1.066.218 1.791.465 2.426a4.909 4.909 0 0 0 1.153 1.771c.5.51 1.105.903 1.772 1.154.635.248 1.363.417 2.428.465 1.064.049 1.407.06 4.123.06s3.056-.01 4.123-.06c1.067-.049 1.79-.217 2.426-.465a5.111 5.111 0 0 0 2.925-2.925c.247-.635.416-1.363.465-2.427.048-1.064.06-1.407.06-4.123s-.012-3.057-.06-4.123c-.05-1.067-.218-1.791-.465-2.426a4.903 4.903 0 0 0-1.153-1.771 4.91 4.91 0 0 0-1.772-1.155c-.635-.247-1.363-.416-2.428-.464C15.058 2.012 14.716 2 12 2l.002-.002Z"
}), /*#__PURE__*/React.createElement("path", {
  d: "M12 6.865a5.135 5.135 0 1 0 0 10.27 5.135 5.135 0 0 0 0-10.27Zm0 8.47a3.335 3.335 0 1 1 0-6.671 3.335 3.335 0 0 1 0 6.67ZM17.338 7.862a1.2 1.2 0 1 0 0-2.4 1.2 1.2 0 0 0 0 2.4Z"
...
const ErrorIcon = props => /*#__PURE__*/React.createElement(Icon, props, /*#__PURE__*/React.createElement(Error$1, null));
const FacebookIcon = props => /*#__PURE__*/React.createElement(Icon, props, /*#__PURE__*/React.createElement(FacebookMono, null));
const InstagramIcon = props => /*#__PURE__*/React.createElement(Icon, props, /*#__PURE__*/React.createElement(Instagram, null));
const ListViewIcon = props => /*#__PURE__*/React.createElement(Icon, props, /*#__PURE__*/React.createElement(ListView, null));
const PocketLogoIcon = props => /*#__PURE__*/React.createElement(Icon, props, /*#__PURE__*/React.createElement(PocketLogo, null));
const SettingsIcon = props => /*#__PURE__*/React.createElement(Icon, props, /*#__PURE__*/React.createElement(Settings, null));
const TwitterIcon = props => /*#__PURE__*/React.createElement(Icon, props, /*#__PURE__*/React.createElement(TwitterMono, null));

const buttonStyles = "bzy3u3x";
const Button = ({
  children,
  onClick,
  type = 'primary',
  ...
  return /*#__PURE__*/React.createElement("button", {
    className: cx$1('pocket-button', buttonStyles, type, className),
    onClick: onClick
  }, children);
};

const globalReset = "g366awb";
const globalVariables = "g1wkq7a6";
const radioStyles = "r1qhzvgw";

export { Button as B, ErrorIcon as E, FacebookIcon as F, InstagramIcon as I, ListViewIcon as L, PropTypes as P, ReactDOM as R, SettingsIcon as S, TwitterIcon as T, _extends as _, React as a, globalVariables as b, cx$1 as c, PocketLogoIcon as d, radioStyles as e, globalReset as g, propTypes as p, react as r };
