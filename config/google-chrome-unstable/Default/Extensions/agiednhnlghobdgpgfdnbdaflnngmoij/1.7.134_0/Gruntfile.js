module.exports = function(grunt) {
    ...
    grunt.initConfig({
        ...
        copy: ["config/**", "js/**", "css/*.css", //leave the LESS behind
        "**/*.html", //both main.html and the templates
        "require.js", "background.js", "installer.js", "**/*.png" //in case we add images at some point
        ]
    });
    ...
    grunt.registerTask("types", "Update supported file types from ace.json", function() {
        var json = JSON.parse(fs.readFileSync("config/ace.json", {
            encoding: "utf8"
        }));
        var types = {};
