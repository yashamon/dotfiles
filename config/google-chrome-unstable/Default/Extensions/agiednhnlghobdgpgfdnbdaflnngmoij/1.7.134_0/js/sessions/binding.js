define(["command", "sessions/state", "sessions/addRemove", "ui/contextMenus", "util/manos", "util/dom2"], function(command, state, addRemove, contextMenus, M) {
  ...
  */
    ...
    var enableTabDragDrop = function() {
        ...
        tabContainer.on("drag", function(e) {
            ...
            if (
            e.clientX > tabCoords.left && e.clientX < tabCoords.left + tabCoords.width && e.clientY > tabCoords.top && e.clientY < tabCoords.top + tabCoords.top) return;
    ...
    var enableDblClickNewTab = function() {
        ...
        tabContainer.on("dblclick", function(e) {
            e.preventDefault();
            if (e.button == 0) command.fire("session:new-file");
        });
    };
