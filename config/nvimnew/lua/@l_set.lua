 ...
 C:/Users/yasha/dotfiles/config/nvimnew/lua/set.lua:65:: vim.api.nvim_set_hl(0, 'SpellBad', { fg = '#580058', undercurl = true )
 C:/Users/yasha/dotfiles/config/nvimnew/lua/set.lua:66:: vim.api.nvim_set_hl(0, 'IndentBlanklineSpaceChar', { fg = '#af6000', nocombine = true )
 C:/Users/yasha/dotfiles/config/nvimnew/lua/set.lua:67::    highlight  guifg=#00FF00 gui=nocombine
