 ...
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:22:: vim.keymap.set('t', '<m p>', [[getreg('+')  , {expr = true)
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:23::    LSP
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:24:: 
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:25:: require'nvim treesitter.configs'.setup {
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:26::    ensure_installed = "all",    one of "all", "maintained" (parsers with maintainers), or a list of languages
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:27::   incremental_selection = {
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:28::     enable = true,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:29::     keymaps = {
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:30::       init_selection = '<m CR>',
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:31::         scope_incremental = '<CR>',
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:32::       node_incremental = '<TAB>',
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:33::       node_decremental = '<S TAB>',
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:34::     ,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:35::   ,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:36::   highlight = {
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:37::     enable = true,                 false will disable the whole extension
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:38::        Instead of true it can also be a list of languages
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:39::     additional_vim_regex_highlighting = false,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:40::   ,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:41:: 
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:42:: require('leap').setup {
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:43::   max_aot_targets = nil,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:44::   highlight_unlabeled = true,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:45::   max_highlighted_traversal_targets = 20,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:46::   case_sensitive = false,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:47::      Sets of characters that should match each other.
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:48::      Obvious candidates are braces and quotes ('([{', ') ', '`" '').
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:49::   equivalence_classes =
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:50::   {
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:51::       {' ', " r", " n" ,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:52::       {' '','"', ':', '=', '#', '&', '%','^', '_', '<', '>', '?', '|', '!', '*', '+', ' ', '`', '/', '  ', ',', '.',';', ' ', '[', '', '{', ')', '(', ' '
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:53::     ,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:54::      Leaving the   appropriate list emapty effectively disables "smart" mode,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:55::      and forces auto jump to be on or off.%
 ...
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:178::   triggers = {"<leader>", "g", "z", ";",    automatically setup triggers
 ...
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:217::         texMath = { fg = "#808080" ,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:218::         Special = { fg = "#650000" ,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:219::         texDelimiter = { fg = "#808080" ,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:220::         texStatement = { fg = "#808080" ,
 ...
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:227::           bright orange  #fd8432
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:228::           texComment = { fg = "#00ff00" ,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:229::            texString = { fg = "#0000ff" ,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:230::            Special = {fg = "#0000ff" ,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:231::            texCmdName = { fg = "#0000ff" ,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:232::            SpecialChar = { fg = "#0000ff" ,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:233::            Statement = { fg = "#0000ff" 
 ...
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:237::    nvim LSP
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:238:: require('snippets')
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:239:: require("mason").setup()
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:240:: require("mason lspconfig").setup()
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:241:: require("lspconfig")
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:242::    LSP config
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:243:: local lspconfig = require("lspconfig")
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:244:: 
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:245::     lspconfig.sumneko_lua.setup { on_attach = on_attach 
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:246::     lspconfig.tsserver.setup { on_attach = on_attach 
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:247::     lspconfig.jsonls.setup { on_attach = on_attach 
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:248::     lspconfig.rome.setup { on_attach = on_attach 
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:249::     lspconfig.vimls.setup { on_attach = on_attach 
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:250::     lspconfig.ltex.setup { autostart = false;
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:251::        on_attach = on_attach 
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:252::     lspconfig.texlab.setup { on_attach = on_attach 
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:253::    lspconfig stuff    
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:254::    local nvim_lsp = require('lspconfig')
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:255::    Use an on_attach function to only map the following keys
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:256::    after the language server attaches to the current buffer
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:257:: local on_attach = function(client, bufnr)
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:258:: local function buf_set_keymap(...) vim.api.nvim_buf_set_keymap(bufnr, ...) end
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:259:: local function buf_set_option(...) vim.api.nvim_buf_set_option(bufnr, ...) end
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:260:: 
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:261::     Enable completion triggered by <c x><c o>
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:262:: buf_set_keymap('omnifunc', 'v:lua.vim.lsp.omnifunc')
 ...
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:290::   if vim.api.nvim_buf_get_option(0, "buftype") == "prompt" then
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:291::     return false
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:292::   end
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:293::   local line, col = unpack(vim.api.nvim_win_get_cursor(0))
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:294::   return col ~= 0 and vim.api.nvim_buf_get_lines(0, line   1, line, true)[1 :sub(col, col):match("%s") == nil
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:295:: end
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:296:: 
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:297:: local feedkey = function(key, mode)
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:298::   vim.api.nvim_feedkeys(vim.api.nvim_replace_termcodes(key, true, true, true), mode, true)
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:299:: end
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:300:: local luasnip = require("luasnip")
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:301:: local cmp = require'cmp'
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:302:: cmp.setup ({
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:303:: snippet = {
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:304::   expand = function(args)
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:305::     luasnip.lsp_expand(args.body)
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:306::   end
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:307:: ,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:308:: 
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:309:: mapping = cmp.mapping.preset.insert({
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:310::         ["<C p>"  = cmp.mapping.select_prev_item(),
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:311::         ["<C n>"  = cmp.mapping.select_next_item(),
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:312::        ['<C d>'  = cmp.mapping.scroll_docs( 4),
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:313::       ['<C f>'  = cmp.mapping.scroll_docs(4),
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:314::       ['<C x>'  = cmp.mapping.complete(),
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:315::       ['<C e>'  = cmp.mapping.close(),
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:316::       ['<CR>'  = cmp.mapping.confirm({ select = true ),
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:317::    ... Your other mappings ...
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:318:: ["<Tab>"  = cmp.mapping(function(fallback)
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:319:: 			if luasnip.expandable() then
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:320:: 				luasnip.expand()
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:321::                         elseif cmp.visible() then
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:322::                              cmp.select_next_item()
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:323:: 			elseif has_words_before() then
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:324:: 				cmp.complete()
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:325::                              else
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:326:: 				fallback()
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:327:: 			end
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:328:: 		end, { "i", "s" ),
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:329:: 		["<S Tab>"  = cmp.mapping(function(fallback)
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:330:: 			if cmp.visible() then
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:331:: 				cmp.select_prev_item()
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:332:: 			elseif luasnip.jumpable( 1) then
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:333:: 				luasnip.jump( 1)
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:334:: 			else
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:335:: 				fallback()
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:336:: 			end
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:337:: 		end, { "i", "s" ),
 ...
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:341:: requires = {
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:342::     {
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:343::       'tzachar/fuzzy.nvim',
 ...
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:355:: { name = 'tags' ,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:356:: { name = 'nvim_lsp', keyword_length = 2 ,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:357:: { name = 'luasnip', keyword_length = 4 ,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:358::    For ultisnips user.
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:359::          { name = 'ultisnips' ,  
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:360:: { name = 'omni', keyword_length = 4,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:361::           { name = 'spell' , 
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:362::         { name = 'treesitter', keyword_length = 4 ,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:363:: { name = 'buffer', keyword_length = 4 ,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:364::   { name = 'fuzzy_buffer', keyword_length = 8 
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:365:: ),
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:366:: completion = { autocomplete = false 
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:367:: )
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:368:: 
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:369:: require('nvim_comment').setup({
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:370::       Linters prefer comment and line to have a space in between markers
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:371::    marker_padding = true,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:372::       should comment out empty or whitespace only lines
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:373::    comment_empty = true,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:374::       Should key mappings be created
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:375::    create_mappings = true,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:376::       Normal mode mapping left hand side
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:377::    line_mapping = "gc",
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:378::       Visual/Operator mapping left hand side
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:379::    operator_mapping = "<leader>c",
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:380::       Hook function to call before commenting takes place
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:381::      hook = nil 
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:382::  )
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:383:: require('spellsitter').setup {
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:384::   hl = 'SpellBad',
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:385::   captures = {,     set to { to spellcheck everything
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:386:: 
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:387::      Spellchecker to use. values:
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:388::      * vimfn: built in spell checker using vim.fn.spellbadword()
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:389::      * ffi: built in spell checker using the FFI to access the
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:390::        internal spell_check() function
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:391:: spellchecker = 'vimfn'
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:392:: 
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:393:: 
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:394:: require('lualine').setup {
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:395::   options = {
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:396::        theme = 
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:397::     theme = require('theme').theme(),
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:398::     icons_enabled = true,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:399::     component_separators = { left = '', right = '',
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:400::     section_separators = { left = '', right = '',
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:401::     disabled_filetypes = {
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:402::       statusline = {,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:403::       winbar = {,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:404::     ,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:405::     ignore_focus = {'tex', 'md', 'text', 'lua', 'latex', 'nu',
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:406::     always_divide_middle = true,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:407::     globalstatus = true,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:408::     refresh = {
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:409::       statusline = 1000,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:410::       tabline = 1000,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:411::       winbar = 1000,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:412::     
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:413::   ,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:414::   sections = {
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:415::   lualine_a = {
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:416::         {
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:417::           'filename',
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:418::           color = 'lualine_a_normal',
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:419::           file_status = true,         Displays file status (readonly status, modified status)
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:420::           newfile_status = false,      Display new file status (new file means no write after created)
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:421::           path = 3,                   0: Just the filename
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:422::                                       1: Relative path
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:423::                                       2: Absolute path
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:424::                                       3: Absolute path, with tilde as the home directory
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:425::           symbols = {
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:426::             modified = '[+ ',         Text to show when the file is modified.
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:427::             readonly = '[  ',         Text to show when the file is non modifiable or readonly.
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:428::             unnamed = '[No Name ',    Text to show for unnamed buffers.
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:429::             newfile = '[New ',        Text to show for new created file before first writting
 ...
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:433::       lualine_b = {{'branch', 'diff', 'diagnostics', color = 'lualine_b_normal',
 ...
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:437::     lualine_z = {{'location', color = 'lualine_z_normal'
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:438::   ,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:439::   inactive_sections = {
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:440::     lualine_a = {,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:441::     lualine_b = {,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:442::     lualine_c = {,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:443::     lualine_x = {,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:444::     lualine_y = {,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:445::     lualine_z = {
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:446::   ,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:447::   tabline = {,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:448::   winbar = {,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:449::   inactive_winbar = {,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:450::   extension = {
 ...
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:454::      gitgutter
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:455::    require('gitsigns').setup{
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:456::      on_attach = function(bufnr)
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:457::        local gs = package.loaded.gitsigns
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:458::   
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:459::        local function map(mode, l, r, opts)
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:460::          opts = opts or {
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:461::          opts.buffer = bufnr
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:462::          vim.keymap.set(mode, l, r, opts)
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:463::        end
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:464::   
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:465::           Navigation
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:466::        map('n', ' c', function()
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:467::          if vim.wo.diff then return ' c' end
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:468::          vim.schedule(function() gs.next_hunk() end)
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:469::          return '<Ignore>'
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:470::        end, {expr=true)
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:471::   
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:472::        map('n', '[c', function()
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:473::          if vim.wo.diff then return '[c' end
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:474::          vim.schedule(function() gs.prev_hunk() end)
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:475::          return '<Ignore>'
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:476::        end, {expr=true)
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:477::   
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:478::           Actions
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:479::        map({'n', 'v', '<leader>hs', ':Gitsigns stage_hunk<CR>')
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:480::        map({'n', 'v', '<leader>hr', ':Gitsigns reset_hunk<CR>')
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:481::        map('n', '<leader>hS', gs.stage_buffer)
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:482::        map('n', '<leader>hu', gs.undo_stage_hunk)
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:483::        map('n', '<leader>hR', gs.reset_buffer)
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:484::        map('n', '<leader>hp', gs.preview_hunk)
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:485::        map('n', '<leader>hb', function() gs.blame_line{full=true end)
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:486::        map('n', '<leader>tb', gs.toggle_current_line_blame)
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:487::        map('n', '<leader>hd', gs.diffthis)
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:488::        map('n', '<leader>hD', function() gs.diffthis('~') end)
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:489::        map('n', '<leader>td', gs.toggle_deleted)
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:490::   
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:491::           Text object
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:492::        map({'o', 'x', 'ih', ':<C U>Gitsigns select_hunk<CR>')
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:493::      end
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:494::    
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:495:: 
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:496::    load snippets from path/of/your/nvim/config/my cool snippets
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:497::   vim.o.runtimepath = vim.o.runtimepath .. 'C:/Users/yasha/.config/nvim/lua/snippets,'
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:498::    require("luasnip/loaders/from_vscode").lazy_load()    load snippets of friendly/snippets
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:499::    require("luasnip/loaders/from_vscode").load({ paths = "C:/Users/yasha/dotfiles/snippets" )    load your own snippets
