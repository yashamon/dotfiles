...
au('BufWritePost', { callback = function() GitAsync()
CG() end })
au({'Filetype', 'BufReadPost'}, { pattern = 'tex', callback = LoadLine  } )
au({'Filetype', 'BufReadPost'}, { pattern = 'text,lua,vim,nu,py', callback = LoadSentence } )
