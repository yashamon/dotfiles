 ...
 C:/Users/yasha/dotfiles/config/nvimnew/lua/keymaps.lua:7::       vim.cmd('sleep 100m')
 C:/Users/yasha/dotfiles/config/nvimnew/lua/keymaps.lua:8::       vim.api.nvim_feedkeys(vim.api.nvim_replace_termcodes('<C w>jzf', true, false, true), 'im', false) end
 C:/Users/yasha/dotfiles/config/nvimnew/lua/keymaps.lua:9::    end, { buffer=true )
 C:/Users/yasha/dotfiles/config/nvimnew/lua/keymaps.lua:10:: 
 C:/Users/yasha/dotfiles/config/nvimnew/lua/keymaps.lua:11::    nnoremap <m t> :up<cr>:BTags<cr>:call feedkeys(" <c a> <c q>")<cr>:copen<cr>
