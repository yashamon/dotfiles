 ...
 C:/Users/yasha/dotfiles/config/nvimnew/lua/keymaps.lua:4::    vim.api.nvim_feedkeys(nvim_replace_termcodes("<C a><C q>", true, false, true), i, false)
 C:/Users/yasha/dotfiles/config/nvimnew/lua/keymaps.lua:5::    vim.cmd('sleep 30m')
