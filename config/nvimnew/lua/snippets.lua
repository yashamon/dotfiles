...
{
text({'insert('}), insert(1,"n"), text({","}),
insert(2, "insert"), text({"\")"})
})
},
})
...
text({"",'\\address{Bernal Díaz del Castillo 340, \\\\'}),
text({"",'Col. Villas San Sebastian, \\\\'}),
text({"",'28045 Colima, Colima, \\\\'}),
text({"",'Mexico}'}),
text({"",'\\date{'}), insert(1,"date"), text({'}'}),
text({"","\\begin{document}"}),
text({"","\\begin{letter}{}"}),
text({"","\\opening{"}), insert(2,"opening"), text({'}'}),
text({""}), insert(3, "write letter"),
