 ...
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:219::            Operator = { fg = "#808080" ,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:220::         Type = { fg = "#008800" ,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:221::         Comment = { fg = "#af6000" ,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:222::         String = { fg = "#580058" ,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:223::         Operator = { fg = "#580058" ,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:224::         Pmenu = { bg = "#ffa546", fg = "#1e2030" ,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:225:: 				texTypeStyle = { fg = "#427b58" 
 ...
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:258::   
 ...
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:262:: require'lspconfig'.sumneko_lua.setup(require("lualsp"))    Mappings.
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:263:: local opts = { noremap=true, silent=true 
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:264:: 
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:265::      See `:help vim.lsp.*` for documentation on any of the below functions
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:266::   buf_set_keymap('n', 'gD', '<cmd>lua vim.lsp.buf.declaration()<CR>', opts)
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:267::   buf_set_keymap('n', 'gd', '<cmd>lua vim.lsp.buf.definition()<CR>', opts)
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:268::     buf_set_keymap('n', 'K', '<cmd>lua vim.lsp.buf.hover()<CR>', opts)
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:269::   buf_set_keymap('n', 'gi', '<cmd>lua vim.lsp.buf.implementation()<CR>', opts)
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:270::   buf_set_keymap('n', '<S C k>', '<cmd>lua vim.lsp.buf.signature_help()<CR>', opts)
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:271::   buf_set_keymap('n', 'gwa', '<cmd>lua vim.lsp.buf.add_workspace_folder()<CR>', opts)
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:272::   buf_set_keymap('n', 'gwr', '<cmd>lua vim.lsp.buf.remove_workspace_folder()<CR>', opts)
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:273::   buf_set_keymap('n', 'gwl', '<cmd>lua print(vim.inspect(vim.lsp.buf.list_workspace_folders()))<CR>', opts)
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:274::   buf_set_keymap('n', 'gtD', '<cmd>lua vim.lsp.buf.type_definition()<CR>', opts)
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:275::   buf_set_keymap('n', '<space>rn', '<cmd>lua vim.lsp.buf.rename()<CR>', opts)
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:276::   buf_set_keymap('n', 'ga', '<cmd>lua vim.lsp.buf.code_action()<CR>', opts)
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:277::   buf_set_keymap('n', 'gr', '<cmd>lua vim.lsp.buf.references()<CR>', opts)
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:278::   buf_set_keymap('n', 'gld', '<cmd>lua vim.lsp.diagnostic.show_line_diagnostics()<CR>', opts)
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:279::   buf_set_keymap('n', '[d', '<cmd>lua vim.lsp.diagnostic.goto_prev()<CR>', opts)
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:280::   buf_set_keymap('n', ' d', '<cmd>lua vim.lsp.diagnostic.goto_next()<CR>', opts)
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:281::   buf_set_keymap('n', 'gq', '<cmd>lua vim.lsp.diagnostic.set_loclist()<CR>', opts)
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:282::   buf_set_keymap('n', 'gf', '<cmd>lua vim.lsp.buf.formatting()<CR>', opts)
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:283:: end
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:284:: 
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:285::      Setup cmp.
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:286:: 
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:287:: local has_words_before = function()
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:288::   unpack = unpack or table.unpack
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:289::   local line, col = unpack(vim.api.nvim_win_get_cursor(0))
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:290::   return col ~= 0 and vim.api.nvim_buf_get_lines(0, line   1, line, true)[1 :sub(col, col):match("%s") == nil
 ...
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:334:: requires = {
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:335::     {
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:336::       'quangnguyen30192/cmp nvim tags',
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:337::          if you want the sources is available for some file types
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:338::       ft = {
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:339::         'tex',
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:340::         'latex'
 ...
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:344::    ... Your other configuration ...
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:345:: sources = cmp.config.sources({
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:346::          For vsnip user. 
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:347:: { name = 'tags', keyword_length = 1000 ,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:348:: { name = 'nvim_lsp', keyword_length = 3 ,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:349:: { name = 'luasnip', keyword_length = 2 ,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:350::    { name = 'omni', keyword_length = 4,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:351::           { name = 'spell' , 
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:352::         { name = 'treesitter', keyword_length = 4 ,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:353:: { name = 'buffer', keyword_length = 4 ,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:354::   { name = 'fuzzy_buffer', keyword_length = 8 
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:355:: ),
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:356:: completion = { autocomplete = false 
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:357:: )
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:358:: 
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:359:: require('nvim_comment').setup({
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:360::       Linters prefer comment and line to have a space in between markers
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:361::    marker_padding = true,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:362::       should comment out empty or whitespace only lines
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:363::    comment_empty = true,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:364::       Should key mappings be created
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:365::    create_mappings = true,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:366::       Normal mode mapping left hand side
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:367::    line_mapping = "gc",
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:368::       Visual/Operator mapping left hand side
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:369::    operator_mapping = "<leader>c",
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:370::       Hook function to call before commenting takes place
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:371::      hook = nil 
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:372::  )
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:373:: require('spellsitter').setup {
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:374::   hl = 'SpellBad',
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:375::   captures = {,     set to { to spellcheck everything
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:376:: 
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:377::      Spellchecker to use. values:
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:378::      * vimfn: built in spell checker using vim.fn.spellbadword()
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:379::      * ffi: built in spell checker using the FFI to access the
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:380::        internal spell_check() function
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:381:: spellchecker = 'vimfn'
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:382:: 
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:383:: 
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:384:: require('lualine').setup {
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:385::   options = {
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:386::        theme = 
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:387::     theme = require('theme').theme(),
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:388::     icons_enabled = true,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:389::     component_separators = { left = '', right = '',
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:390::     section_separators = { left = '', right = '',
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:391::     disabled_filetypes = {
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:392::       statusline = {,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:393::       winbar = {,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:394::     ,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:395::     ignore_focus = {'tex', 'md', 'text', 'lua', 'latex', 'nu',
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:396::     always_divide_middle = true,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:397::     globalstatus = true,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:398::     refresh = {
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:399::       statusline = 1000,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:400::       tabline = 1000,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:401::       winbar = 1000,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:402::     
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:403::   ,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:404::   sections = {
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:405::   lualine_a = {
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:406::         {
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:407::           'filename',
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:408::           color = 'lualine_a_normal',
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:409::           file_status = true,         Displays file status (readonly status, modified status)
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:410::           newfile_status = false,      Display new file status (new file means no write after created)
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:411::           path = 3,                   0: Just the filename
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:412::                                       1: Relative path
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:413::                                       2: Absolute path
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:414::                                       3: Absolute path, with tilde as the home directory
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:415::           symbols = {
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:416::             modified = '[+ ',         Text to show when the file is modified.
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:417::             readonly = '[  ',         Text to show when the file is non modifiable or readonly.
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:418::             unnamed = '[No Name ',    Text to show for unnamed buffers.
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:419::             newfile = '[New ',        Text to show for new created file before first writting
 ...
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:423::       lualine_b = {{'branch', 'diff', 'diagnostics', color = 'lualine_b_normal',
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:424::     lualine_c = {,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:425::     lualine_x = {,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:426::     lualine_y = {,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:427::     lualine_z = {{'location', color = 'lualine_z_normal'
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:428::   ,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:429::   inactive_sections = {
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:430::     lualine_a = {,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:431::     lualine_b = {,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:432::     lualine_c = {,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:433::     lualine_x = {,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:434::     lualine_y = {,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:435::     lualine_z = {
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:436::   ,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:437::   tabline = {,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:438::   winbar = {,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:439::   inactive_winbar = {,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:440::   extension = {
 ...
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:444::      gitgutter
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:445::    require('gitsigns').setup{
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:446::      on_attach = function(bufnr)
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:447::        local gs = package.loaded.gitsigns
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:448::   
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:449::        local function map(mode, l, r, opts)
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:450::          opts = opts or {
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:451::          opts.buffer = bufnr
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:452::          vim.keymap.set(mode, l, r, opts)
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:453::        end
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:454::   
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:455::           Navigation
 ...
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:458::          vim.schedule(function() gs.next_hunk() end)
 ...
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:464::          vim.schedule(function() gs.prev_hunk() end)
 ...
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:468::           Actions
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:469::        map({'n', 'v', '<leader>hs', ':Gitsigns stage_hunk<CR>')
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:470::        map({'n', 'v', '<leader>hr', ':Gitsigns reset_hunk<CR>')
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:471::        map('n', '<leader>hS', gs.stage_buffer)
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:472::        map('n', '<leader>hu', gs.undo_stage_hunk)
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:473::        map('n', '<leader>hR', gs.reset_buffer)
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:474::        map('n', '<leader>hp', gs.preview_hunk)
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:475::        map('n', '<leader>hb', function() gs.blame_line{full=true end)
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:476::        map('n', '<leader>tb', gs.toggle_current_line_blame)
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:477::        map('n', '<leader>hd', gs.diffthis)
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:478::        map('n', '<leader>hD', function() gs.diffthis('~') end)
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:479::        map('n', '<leader>td', gs.toggle_deleted)
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:480::   
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:481::           Text object
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:482::        map({'o', 'x', 'ih', ':<C U>Gitsigns select_hunk<CR>')
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:483::      end
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:484::    
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:485:: 
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:486::    load snippets from path/of/your/nvim/config/my cool snippets
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:487::   vim.o.runtimepath = vim.o.runtimepath .. 'C:/Users/yasha/.config/nvim/lua/snippets,'
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:488::    require("luasnip/loaders/from_vscode").lazy_load()    load snippets of friendly/snippets
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:489::    require("luasnip/loaders/from_vscode").load({ paths = "C:/Users/yasha/dotfiles/snippets" )    load your own snippets
