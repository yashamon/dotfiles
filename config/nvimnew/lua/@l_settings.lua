 ...
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:26:: 
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:27:: require'nvim treesitter.configs'.setup {
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:28::    ensure_installed = "all",    one of "all", "maintained" (parsers with maintainers), or a list of languages
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:29::   incremental_selection = {
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:30::     enable = true,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:31::     keymaps = {
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:32::       init_selection = '<m CR>',
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:33::         scope_incremental = '<CR>',
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:34::       node_incremental = '<TAB>',
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:35::       node_decremental = '<S TAB>',
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:36::     ,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:37::   ,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:38::   highlight = {
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:39::     enable = true,                 false will disable the whole extension
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:40::        Instead of true it can also be a list of languages
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:41::     additional_vim_regex_highlighting = false,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:42::   ,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:43:: 
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:44:: require('leap').setup {
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:45::   max_aot_targets = nil,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:46::   highlight_unlabeled = true,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:47::   max_highlighted_traversal_targets = 20,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:48::   case_sensitive = false,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:49::      Sets of characters that should match each other.
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:50::      Obvious candidates are braces and quotes ('([{', ') ', '`" '').
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:51::   equivalence_classes =
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:52::   {
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:53::       {' ', " r", " n" ,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:54::       {' '','"', ':', '=', '#', '&', '%','^', '_', '<', '>', '?', '|', '!', '*', '+', ' ', '`', '/', '  ', ',', '.',';', ' ', '[', '', '{', ')', '(', ' '
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:55::     ,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:56::      Leaving the   appropriate list emapty effectively disables "smart" mode,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:57::      and forces auto jump to be on or off.%
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:58:: 
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:59:: vim.api.nvim_set_hl(0, 'LeapMatch', { fg='white' )
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:60:: 
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:61:: require("todo comments").setup {
 ...
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:64::        refer to the configuration section below
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:65:: 
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:66:: 
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:67:: require('telescope').setup({
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:68::   defaults = {
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:69::     layout_config = {
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:70::       vertical = { width = 0.9 
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:71::          other layout configuration here
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:72::     ,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:73::     scroll_strategy = 'limit',
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:74::      previewers = {
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:75::     {
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:76::       filesize_limit = 25,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:77::       timeout = 300,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:78::       use_highlighter = false
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:79::     
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:80::  ,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:81::        other defaults configuration here
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:82::   ,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:83::      other configuration values here
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:84:: )
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:85::    require("tokyonight").setup({
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:86::         your configuration comes here
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:87::         or leave it empty to use the default settings
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:88::      style = "storm",    The theme comes in three styles, `storm`, `moon`, a darker variant `night` and `day`
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:89::      light_style = "day",    The theme is used when the background is set to light
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:90::      transparent = false,    Enable this to disable setting the background color
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:91::      terminal_colors = true,    Configure the colors used when opening a `:terminal` in Neovim
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:92::      styles = {
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:93::           Style to be applied to different syntax groups
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:94::           Value is any valid attr list value for `:help nvim_set_hl`
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:95::        comments = { italic = true ,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:96::        keywords = { italic = true ,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:97::        functions = {,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:98::        variables = {,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:99::           Background styles. Can be "dark", "transparent" or "normal"
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:100::        sidebars = "dark",    style for sidebars, see below
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:101::        floats = "dark",    style for floating windows
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:102::      ,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:103::      sidebars = { "qf", "help" ,    Set a darker background on sidebar like windows. For example: `["qf", "vista_kind", "terminal", "packer" `
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:104::      day_brightness = 0.1,    Adjusts the brightness of the colors of the **Day** style. Number between 0 and 1, from dull to vibrant colors
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:105::      hide_inactive_statusline = true,    Enabling this option, will hide inactive statuslines and replace them with a thin border instead. Should work with the standard **StatusLine** and **LuaLine**.
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:106::      dim_inactive = true,    dims inactive windows
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:107::      lualine_bold = false,    When `true`, section headers in the lualine theme will be bold
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:108::   
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:109::          You can override specific color groups to use other groups or a hex color
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:110::          function will be called with a ColorScheme table
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:111::         @param colors ColorScheme
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:112::        on_colors = function(colors) 
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:113::        colors.normal = colors.black 
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:114::        end,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:115::   
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:116::          You can override specific highlights to use other groups or a hex color
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:117::          function will be called with a Highlights and ColorScheme table
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:118::         @param highlights Highlights
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:119::         @param colors ColorScheme
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:120::         on_highlights = function(highlights, colors)
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:121::         end,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:122::    )
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:123:: require("which key").setup({
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:124::   plugins = {
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:125::     marks = true,    shows a list of your marks on ' and `
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:126::     registers = true,    shows your registers on " in NORMAL or <C r> in INSERT mode
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:127::     spelling = {
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:128::       enabled = false,    enabling this will show WhichKey when pressing z= to select spelling suggestions
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:129::       suggestions = 50,    how many suggestions should be shown in the list?
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:130::     ,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:131::        the presets plugin, adds help for a bunch of default keybindings in Neovim
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:132::        No actual key bindings are created
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:133::     presets = {
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:134::       operators = true,    adds help for operators like d, y, ... and registers them for motion / text object completion
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:135::       motions = true,    adds help for motions
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:136::       text_objects = true,    help for text objects triggered after entering an operator
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:137::       windows = true,    default bindings on <c w>
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:138::       nav = true,    misc bindings to work with windows
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:139::       z = true,    bindings for folds, spelling and others prefixed with z
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:140::       g = true,    bindings for prefixed with g
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:141::     ,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:142::   ,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:143::      add operators that will trigger motion and text object completion
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:144::      to enable all native operators, set the preset / operators plugin above
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:145::   operators = { gc = "Comments" ,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:146::   key_labels = {
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:147::        override the label used to display some keys. It doesn't effect WK in any other way.
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:148::        For example:
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:149::        ["<space>"  = "SPC",
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:150::        ["<cr>"  = "RET",
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:151::        ["<tab>"  = "TAB",
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:152::   ,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:153::   icons = {
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:154::     breadcrumb = "»",    symbol used in the command line area that shows your active key combo
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:155::     separator = "➜",    symbol used between a key and it's label
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:156::     group = "+",    symbol prepended to a group
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:157::   ,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:158::   popup_mappings = {
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:159::     scroll_down = '<c d>',    binding to scroll down inside the popup
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:160::     scroll_up = '<c u>',    binding to scroll up inside the popup
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:161::   ,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:162::   window = {
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:163::     border = "none",    none, single, double, shadow
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:164::     position = "bottom",    bottom, top
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:165::     margin = { 1, 0, 1, 0 ,    extra window margin [top, right, bottom, left 
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:166::     padding = { 2, 2, 2, 2 ,    extra window padding [top, right, bottom, left 
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:167::     winblend = 0
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:168::   ,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:169::   layout = {
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:170::     height = { min = 50, max = 50 ,    min and max height of the columns
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:171::     width = { min = 10, max = 50 ,    min and max width of the columns
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:172::     spacing = 3,    spacing between columns
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:173::     align = "left",    align columns left, center or right
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:174::   ,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:175::   ignore_missing = false,    enable this to hide mappings for which you didn't specify a label
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:176::   hidden = { "<silent>", "<cmd>", "<Cmd>", "<CR>", "call", "lua", "^:", "^ ",    hide mapping boilerplate
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:177::   show_help = true,    show help message on the command line when the popup is visible
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:178::   show_keys = true,    show the currently pressed key and its label as a message in the command line
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:179::   triggers = {"<leader>", "g", ";",    automatically setup triggers
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:180::      triggers = {"<leader>"    or specify a list manually
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:181::   triggers_blacklist = {
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:182::        list of mode / prefixes that should never be hooked by WhichKey
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:183::        this is mostly relevant for key maps that start with a native binding
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:184::        most people should not need to change this
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:185::     i = { "j", "k" ,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:186::     v = { "j", "k" ,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:187::   ,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:188::      disable the WhichKey popup for certain buf types and file types.
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:189::      Disabled by deafult for Telescope
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:190::   disable = {
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:191::     buftypes = {,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:192::     filetypes = { "TelescopePrompt" ,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:193::   ,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:194:: )
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:195:: require("gruvbox").setup({
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:196:: undercurl = true,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:197::   underline = true,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:198::   bold = true,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:199::   italic = true,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:200::   strikethrough = false,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:201::   invert_selection = false,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:202::   invert_signs = false,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:203::   invert_tabline = false,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:204::   invert_intend_guides = false,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:205::   inverse = false,    invert background for search, diffs, statuslines and errors
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:206::   contrast = "hard",    can be "hard", "soft" or empty string
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:207::   palette_overrides = {,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:208::   dim_inactive = false,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:209::   transparent_mode = false,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:210::     overrides = {
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:211::         SignColumn = {bg = "#ffa546",
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:212::         Normal = {bg = "#ffa546",
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:213::         DiagnosticSignError = { bg = "#ffa546" ,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:214::         DiagnosticSignWarn = { bg = "#ffa546" ,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:215::         DiagnosticSignInfo = { bg = "#ffa546" ,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:216::         DiagnosticSignHint = { bg = "#ffa546" ,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:217::         texType = { fg = "#808080" ,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:218::         texMath = { fg = "#650000" ,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:219::         TexSpecial = { fg = "#af6000" ,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:220::         texDelimiter = { fg = "#af6000" ,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:221::         texStatement = { fg = "#580058" ,
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:222:: 				texRefzone = { fg = "#af6000" ,
 ...
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:455::        map('n', ' c', function()
 ...
 C:/Users/yasha/dotfiles/config/nvimnew/lua/settings.lua:461::        map('n', '[c', function()
