 ...
 C:/Users/yasha/dotfiles/config/nvimnew/lua/functions.lua:23::    require('telescope.builtin').quickfix({layout_strategy='vertical',layout_config={width=0.9)
 C:/Users/yasha/dotfiles/config/nvimnew/lua/functions.lua:24:: end
 C:/Users/yasha/dotfiles/config/nvimnew/lua/functions.lua:25:: 
 C:/Users/yasha/dotfiles/config/nvimnew/lua/functions.lua:26:: Sentence = function ()
 C:/Users/yasha/dotfiles/config/nvimnew/lua/functions.lua:27::    local filename = vim.fn.substitute(vim.fn.expand('%:p'), "  ", "/", "g")
 C:/Users/yasha/dotfiles/config/nvimnew/lua/functions.lua:28::    local filenameshort = vim.fn.substitute(vim.fn.expand('%'), "  ", "/", "g")
 C:/Users/yasha/dotfiles/config/nvimnew/lua/functions.lua:29::    local execstr = "nu C:/Users/yasha/dotfiles/scripts/sentence.nu " .. filename
 C:/Users/yasha/dotfiles/config/nvimnew/lua/functions.lua:30::    local vimcmd = 'let id = jobstart([ 'nu ',  'C:/Users/yasha/dotfiles/scripts/sentence.nu ', substitute(expand( '%:p '), "    ", "/", "g") , { 'rpc ': v:true)'
 C:/Users/yasha/dotfiles/config/nvimnew/lua/functions.lua:31::    print(vimcmd)
 C:/Users/yasha/dotfiles/config/nvimnew/lua/functions.lua:32::    vim.cmd(vimcmd)
 C:/Users/yasha/dotfiles/config/nvimnew/lua/functions.lua:33::    vim.cmd('call jobwait([id )') 
 C:/Users/yasha/dotfiles/config/nvimnew/lua/functions.lua:34::    local command = "cg " .. "@_" .. filenameshort
 C:/Users/yasha/dotfiles/config/nvimnew/lua/functions.lua:35::    vim.cmd(command)
 C:/Users/yasha/dotfiles/config/nvimnew/lua/functions.lua:36::    vim.cmd('copen')
 C:/Users/yasha/dotfiles/config/nvimnew/lua/functions.lua:37::       if vim.b.bqf_enabled then
 C:/Users/yasha/dotfiles/config/nvimnew/lua/functions.lua:38::        vim.defer_fn(function()
 C:/Users/yasha/dotfiles/config/nvimnew/lua/functions.lua:39::           vim.api.nvim_input("Gzf")
 C:/Users/yasha/dotfiles/config/nvimnew/lua/functions.lua:40::            vim.api.nvim_feedkeys('zf', 'i', false)
 C:/Users/yasha/dotfiles/config/nvimnew/lua/functions.lua:41::        end, 200) test
 ...
 C:/Users/yasha/dotfiles/config/nvimnew/lua/functions.lua:44::    vim.fn.feedkeys("zf")
