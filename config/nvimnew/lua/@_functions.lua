 ...
 C:/Users/yasha/dotfiles/config/nvimnew/lua/functions.lua:32::       require('telescope.builtin'). test test2 test3 quickfix({layout_strategy='vertical',layout_config={width=0.9)
 ...
 C:/Users/yasha/dotfiles/config/nvimnew/lua/functions.lua:43::         vim.cmd('sleep 10m')
