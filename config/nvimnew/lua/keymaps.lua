...
command('Keymap', 'FzfLua keymaps', {})
command('Cmd', 'FzfLua commands', {})
...
vim.api.nvim_create_user_command("Texlab", function()
  local name = "texlab"

  if vim.lsp.is_enabled(name) then
    vim.lsp.enable(name, false)
    vim.notify("texlab LSP disabled", vim.log.levels.INFO)
  else
    vim.lsp.enable(name, true)
    vim.notify("texlab LSP enabled", vim.log.levels.INFO)
  end
end, {
  desc = "Toggle texlab LSP",
})
...
vim.keymap.set("i", "<M-j>", function()
  ...
  noremap = true,
  silent = true,
  desc = "Next completion item / down",
})
...
vim.keymap.set("i", "<M-k>", function()
  ...
  noremap = true,
  silent = true,
  desc = "Previous completion item / up",
})
