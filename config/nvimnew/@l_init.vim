 ...
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:377::   call setloclist([ )
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:378::   call setloclist(map(copy(a:lines), '{ "filename": v:val '))
 ...
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:394:: nnoremap <m t> :up<cr>:BTags<cr>:call s:myquick()<cr>:lopen<cr>
