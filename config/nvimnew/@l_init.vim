 ...
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:6:: execute 'set runtimepath+=' . s:plug_dir
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:7:: call plug#begin(s:plug_dir)
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:8:: "Plug 'nvim telescope/telescope fzf native.nvim', { 'do': 'make'  asdf
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:9:: Plug 'folke/todo comments.nvim', { 'branch': 'main' 
 ...
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:127:: au Filetype tex,text,md vmap q xi<CR><CR><CR><CR><ESC>kki/begin{comment<cr><cr>/end{comment<esc>kp  
 ...
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:334:: " let g:fzf_preview_window = [ 
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:335:: nnoremap <m t> :up<cr>:BTags<cr>:call s:myquick()<cr>:lopen<cr>
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:336:: nnoremap <m s> :up<cr>:lua Sentence()<cr>
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:337:: nnoremap S :up<cr>:lua Line()<cr>
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:338:: " TODO:Add :up
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:339:: "noremap L <Esc>:AsyncRun sentence.sh %;nvr sentence_%<cr>:echo 'press any key'<cr>:execute 'call getchar()' | BLines<cr>
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:340:: " Line search mapping 
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:341:: " function! Jumpback() 
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:342:: "   K=bufname()
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:343:: "   normal viwhy<esc>:bdelete<cr>:buffer K<c r>+<cr>:ZenMode<cr>
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:344:: " endfunction
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:345:: " 
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:346:: nnoremap <m b> :Buffers<cr>
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:347:: " nnoremap <m b> :lua require('telescope.builtin').buffers({layout_strategy='vertical',layout_config={width=0.9)<cr>
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:348:: nnoremap <m i> :lua require('telescope.builtin').git_bcommits({layout_strategy='vertical',layout_config={width=0.9)<cr>
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:349:: nnoremap <m u> :<Esc>:cg C:/Users/yasha/_vim_mru_files<cr>:copen<cr>:call feedkeys("zf")<CR>
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:350:: " noremap F <Esc>:GFiles<CR>
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:351:: " map <A e> :FZF ~<CR> test test2 test3
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:352:: map <m f> :FZF ~<CR> 
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:353:: " map <m f> :lua require('telescope.builtin').find_files({layout_strategy='vertical',layout_config={width=0.9) ~<CR> 
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:354:: "miscellaneous
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:355:: 
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:356:: " nmap <leader>p :Denite neoyank  default action=append<CR>
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:357:: 
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:358:: " Latex stuff
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:359:: " 
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:360:: nnoremap <leader>gs :up<cr>:source  MYVIMRC<cr> 
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:361:: nnoremap <c e> viwy:cclose<cr>:<c r>+<cr><cr>
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:362:: nnoremap <c p> :<c r>+<cr>
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:363:: nnoremap <m l> viwy:bdelete<cr>:execute "buffer" g:buf<cr>:<c r>+<cr><cr>
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:364:: " noremap <m l> viwy<esc>:bp<cr>:<c r>+<cr>
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:365:: 
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:366:: " nvim comment
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:367:: " 
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:368:: vnoremap <leader>c :'<,'>CommentToggle<cr>
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:369:: nnoremap <leader>c :gc
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:370:: 
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:371:: 
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:372:: " FZF Neoyank yank     
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:373:: 
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:374:: nnoremap <leader>y :FZFNeoyank<cr>
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:375:: nnoremap <leader>Y :FZFNeoyank  P<cr>
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:376:: vnoremap <leader>y :FZFNeoyankSelection<cr>
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:377:: 
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:378:: nnoremap <leader>p :FZFNeoyank +<cr> 
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:379:: 
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:380:: nnoremap <leader>1 :FZFNeoyank 1<cr>
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:381:: nnoremap <leader>P :FZFNeoyank " P+<cr>
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:382:: vnoremap <leader>p :FZFNeoyankSelection +<cr>
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:383:: 
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:384:: " Latex maps
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:385:: nmap <leader>v :call ViewPdf()<cr><cr>
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:386:: map <m v> <esc>:call ViewPdf()<cr><cr>
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:387:: nmap <leader>ll :call CompileLatex()<cr>
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:388:: nmap <leader>lcl :call ClearLatex()<cr>
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:389:: nmap gtd :TodoQuickFix<cr>
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:390:: nmap <leader>ga :TZAtaraxis<CR>
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:391:: nmap <leader>gm :up<cr>:silent ! cat  >> ~/workspace/email.txt; cp  /tmp/temp; make4ht /tmp/temp "mathml,mathjax"; pandoc /tmp/temp.html   from html   to markdown_strict  o /tmp/temp.md; mv /tmp/temp.md %<cr>:e %<cr>:up<cr>:qa<cr>
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:392:: 
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:393:: " Lsp mappings
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:394:: nnoremap <silent> g? <cmd>lua vim.diagnostic.open_float()<CR>
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:395:: noremap ga  :lua vim.lsp.buf.code_action()<CR>
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:396:: noremap <leader>la  :lua vim.lsp.buf.code_action()<CR>
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:397:: nmap <leader>c gc
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:398:: 
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:399:: "Leap
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:400:: map t <Plug>(leap forward)
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:401:: map T <Plug>(leap backward)
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:402:: " Replace the default dictionary completion with fzf based fuzzy completion
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:403:: inoremap <expr> <c x><c k> fzf#vim#complete('cat /usr/share/dict/words')  
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:404:: 
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:405:: ""other maps
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:406:: inoremap <cr> <cr><space><esc>"_s
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:407:: nnoremap o o<space><esc>"_s
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:408:: " map cr
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:409:: " inoremap <cr> <esc> a<cr><space><esc>"_s
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:410:: " inoremap <m cr> <cr><space><esc>"_s
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:411:: let g:neovide_fullscreen=v:true
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:412:: if exists('g:gonvim_running')
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:413::  set guifont=Fira  Code  Light:h18
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:414:: "goneovim specific stuff
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:415:: elseif exists('g:neovide')
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:416::    set guifont=JetBrains  Mono:h18
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:417:: end
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:418:: nnoremap <C c> :set hlsearch!<cr>
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:419:: xnoremap <silent> <cr> "*y:silent! let searchTerm = ' V'.substitute(escape(@*, ' /'), " n", '  n', "g") <bar> let @/ = searchTerm <bar> echo '/'.@/ <bar> call histadd("search", searchTerm) <bar> set hls<cr>
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:420:: inoremap <m d> <C w>
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:421:: 
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:422:: "  1 for jumping backwards.
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:423:: inoremap <silent> <S Tab> <cmd>lua require'luasnip'.jump( 1)<Cr>
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:424:: inoremap <silent> <m j> <cmd>lua require('luasnip').jump(1)<Cr>
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:425:: nnoremap <silent> <m j> <cmd>lua require('luasnip').jump(1)<Cr>
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:426:: inoremap <silent> <m k> <cmd>lua require('luasnip').jump( 1)<Cr>
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:427:: nnoremap <silent> <m k> <cmd>lua require('luasnip').jump( 1)<Cr>
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:428:: " For changing choices in choiceNodes (not strictly necessary for a basic setup). 
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:429:: imap <silent><expr> <C E> luasnip#choice_active() ? '<Plug>luasnip next choice' : '<C E>'
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:430:: smap <silent><expr> <C E> luasnip#choice_active() ? '<Plug>luasnip next choice' : '<C E>'
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:431:: 
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:432:: "Functions
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:433:: 
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:434:: function Bluemoon()
 ...
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:440:: function Deepocean()
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:441::    set background=dark
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:442::    colorscheme material  
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:443::    let g:material_style = 'deep ocean'  
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:444:: endfunction
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:445:: 
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:446:: function Palenight()
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:447::    set background=dark
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:448::    " colorscheme blue moon
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:449::    colorscheme material  
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:450::    let g:material_style = 'palenight'  
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:451:: endfunction
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:452:: function Light()
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:453::    colorscheme gruvbox 
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:454::    set background=light
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:455:: endfunction
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:456:: function Lighter()
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:457::    " colorscheme blue moon
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:458::    colorscheme tokyonight day
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:459:: endfunction
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:460:: 
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:461:: function Dark()
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:462::    set background=dark
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:463::    colorscheme tokyonight moon
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:464:: endfunction
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:465:: 
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:466:: function! Profile()
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:467:: profile start profile.log
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:468:: profile func *
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:469:: profile file *
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:470:: endfunction
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:471:: 
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:472:: command!  bang  nargs=* BLinesB
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:473::       call fzf#vim#grep(
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:474::         'rg   with filename   line number   no heading   smart case . '.fnameescape(expand('%')),1,
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:475::         fzf#vim#with_preview({'options': '  keep right   layout reverse   query '.shellescape(<q args>).'   preview "bat  p   color always {"', 'up:50%'))
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:476:: 
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:477:: function ToggleQuickFix()
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:478::       if empty(filter(getwininfo(), 'v:val.quickfix'))
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:479::       exec "w"
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:480::         let b:filenamedir=expand('%:p:h')
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:481::         echo b:filenamedir
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:482::         let b:filename=expand('%:t:r')
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:483::         let b:errors=b:filenamedir . "/build/" . b:filename .".log"
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:484::         exec "cg" b:errors
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:485::         copen
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:486::         lua <<EOF
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:487::         if vim.w.bqf_enabled then
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:488::     local winid = vim.api.nvim_get_current_win()
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:489::     vim.schedule(function()
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:490::         vim.api.nvim_win_call(winid, function()
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:491::             vim.api.nvim_feedkeys('zffatal', 'im', false)
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:492::         end)
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:493::     end)
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:494:: end
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:495:: EOF
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:496::         endif
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:497:: endfunction 
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:498:: 
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:499:: nnoremap <leader>e :silent call ToggleQuickFix()<CR>
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:500:: function! ClearLatex()
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:501::   silent !rm ./build/* 
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:502:: endfunction 
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:503:: command! SEND call Send()
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:504:: function! Send()
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:505::   " silent call ClearLatex()
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:506::   let b:filenamedir=expand('%:p:h')
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:507::   let b:filename=expand('%:t:r')
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:508::   let buf=bufname()
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:509::   let b:pdf=b:filenamedir . "/build/" . b:filename .".pdf" 
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:510::   let execstr="silent te pwsh  c send " . b:pdf
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:511::   echo execstr
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:512::   exec execstr
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:513::   silent execute "buffer" buf
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:514::   endfunction
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:515:: function! CompileLatex()
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:516::   " silent call ClearLatex()
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:517::   let buf=bufname()
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:518::   silent te pwsh  c latexmk  pvc  halt on error  synctex=1  file line error  f %
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:519::   silent execute "buffer" buf
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:520::   call ViewPdf()
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:521::   call feedkeys(" <cr>")
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:522:: endfunction
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:523:: 
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:524:: function! ViewPdf() 
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:525:: wa
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:526:: let buf=bufname()
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:527:: lua Server()
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:528:: let linenumber=line(".")
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:529:: let colnumber=col(".")
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:530:: let b:filenamedir=expand('%:p:h')
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:531:: let filenametex=expand('%:p:t')
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:532:: let filenametexwhole=expand('%:p')
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:533:: let filenameroot=expand('%:t:r')
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:534:: " let filenamePDF=filename[: 4 ."pdf" 
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:535:: let filenamePDFLinux=b:filenamedir . "/buildback/" . filenameroot . ".pdf"
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:536:: let b:filenamePDFWindows="build  " . filenameroot . ".pdf"
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:537:: " echo b:filenamePDFWindows
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:538:: let execstrLinux="silent te zathura   synctex forward " . linenumber . ":" . colnumber . ":" . filenametexwhole . " " . filenamePDFLinux
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:539:: let execstrWindows="silent te pwsh  c C:/Users/yasha/scoop/shims/sumatrapdf.EXE  reuse instance " . b:filenamePDFWindows . "  forward search " . filenametex . " " . linenumber
 C:/Users/yasha/dotfiles/config/nvimnew/init.vim:540:: exec execstrWindows
