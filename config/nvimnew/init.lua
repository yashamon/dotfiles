...
let execstrWindowsTectonic="silent te pwsh -c tectonic " . filenametex . " --outdir build --synctex --keep-logs " . ";C:/Users/yasha/scoop/shims/sumatrapdf.EXE -reuse-instance " . b:filenamePDFWindows . " -forward-search " . filenametex . " " . linenumber
