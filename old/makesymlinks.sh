...
files="bashrc xmonad/xmonad.hs vnc fasd ctags tmux-conf vimrc vim zshrc oh-my-zsh
vifm/vifmrc vifm/colors  private scrotwm.conf Xresources"    # list of files/folders to symlink in homedir
